...
func (x *logServiceInfoClient) CloseAndRecv() (*emptypb.Empty, error) {
...
func (x *logServiceWarnClient) CloseAndRecv() (*emptypb.Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(emptypb.Empty)
...
func (x *logServiceErrorClient) CloseAndRecv() (*emptypb.Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(emptypb.Empty)
...
func (x *logServiceInfoServer) SendAndClose(m *emptypb.Empty) error {
...
func (x *logServiceWarnServer) SendAndClose(m *emptypb.Empty) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *logServiceErrorServer) SendAndClose(m *emptypb.Empty) error {
	return x.ServerStream.SendMsg(m)
}
...
type AuthServiceClient interface {
	GetToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TokenResponse, error)
...
func (c *authServiceClient) GetToken(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TokenResponse, error) {
...
type AuthServiceServer interface {
	GetToken(context.Context, *emptypb.Empty) (*TokenResponse, error)
...
func (UnimplementedAuthServiceServer) GetToken(context.Context, *emptypb.Empty) (*TokenResponse, error) {
...
func _AuthService_GetToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetToken(ctx, req.(*emptypb.Empty))
	}
...
type MetadataStorageServiceClient interface {
	...
	Set(ctx context.Context, in *SetMetadataStorageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *metadataStorageServiceClient) Set(ctx context.Context, in *SetMetadataStorageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type MetadataStorageServiceServer interface {
	...
	Set(context.Context, *SetMetadataStorageRequest) (*emptypb.Empty, error)
...
func (UnimplementedMetadataStorageServiceServer) Set(context.Context, *SetMetadataStorageRequest) (*emptypb.Empty, error) {
