...
func findMoveTargets(fromDir, toDir string, fo plugin.FileOperation) ([]move, error) {
...
func getDirectMove(fromDir, toDir string, fo plugin.FileOperation) (move, bool, error) {
	var m move
	fromDir, err := filepath.Abs(fromDir)
	if err != nil {
...
func moveFiles(fromDir, toDir string, fo plugin.FileOperation) error {
...
func moveAllFiles(fromDir, toDir string, fos []plugin.FileOperation) error {
	for _, fo := range fos {
...
func moveToInstallDir(srcDir, installDir string, fos []plugin.FileOperation) error {
